...
ggsave(ukb_biomarkers_betas_p, 
       filename = file.path(
         '..', 'figures_supp', 
         'S13.- Biomarkers Betas, including Statin.png'),
       height = 12, width = 10)
```
...
ggsave(
  ...
  filename = file.path('..', 'figures_supp', 
                       'S13.- Biomarkers, including Statin.png'), 
  height = 12, width = 10)
```
...
ggsave(
  ...
  plot_layout(widths = c(0.6, 0.4)),
  filename = file.path('..', 'figures_supp', 
                       'S14i.- Biomarkers, no Statin, Sanger.png'), 
  height = 11, width = 7)
```
...
ggsave(
  ...
  plot_layout(widths = c(0.6, 0.4)),
  filename = file.path('..', 'figures_supp', 
                       'S14ii.- Biomarkers, no Statin, deCODE.png'), 
  height = 11, width = 7)
```
...
ggsave(
  ...
  plot_layout(widths = c(0.6, 0.4)),
  filename = file.path('..', 'figures_supp',
                       'S15A.- Renal Biomarkers, Joint.png'), 
  height = 5.5, width = 10)
```
...
ggsave(
  ...
  plot_layout(widths = c(0.6, 0.4)),
  filename = file.path('..', 'figures_supp', 'S15B.- eGFR, SC.png'), 
  height = 6, width = 10)
```
